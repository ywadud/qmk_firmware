...
MOD_LGUI,MOD_LALT,MOD_LCTL,MOD_LSFT,
// Thumb clusters
#define UC_TL1 KC_DEL
#define UC_TL2 LT(NUMR, KC_BSPC)
#define UC_TL3 LT(NAVR, KC_SPC)

#define UC_TR3 LT(FUNL, KC_ENT)
#define UC_TR2 LT(SYMB, KC_TAB)
#define UC_TR1 KC_ESC
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,   HRM_LG, HRM_LA,  HRM_LC,  HRM_LS,    KC_G,                         KC_H,  HRM_RS,  HRM_RC,  HRM_RA,  HRM_RG, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      _______,  KC_ESC,  KC_SPC,  KC_ENT,  KC_TAB, KC_MSTP,                      KC_PSCR, KC_SCRL,  KC_NUM,  KC_INS,  KC_DEL, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,MOD_LGUI,MOD_LALT,MOD_LCTL,MOD_LSFT, KC_MUTE,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, KC_CAPS, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, KC_MPLY,                      KC_HOME, KC_PGDN, KC_PGUP,  KC_END, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
